...
{
    public partial class TestikantaContext : DbContext
    {
        public TestikantaContext()
        {
        }

        public TestikantaContext(DbContextOptions<TestikantaContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:testi1.database.windows.net;Database=Testikanta;User ID=siiseli@testi1;Password=Nx6LaHVz;Encrypt=True;");
            }
        }
